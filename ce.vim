...
syn keyword	cStatement	goto break return continue asm set new call
syn keyword	cLabel		case default let where func
...
syn keyword	cType		int long short char void val mut
...
syn keyword	cStructure	struct union enum typedef data
